...
public class GameView extends LinearLayout {
    ...
    private void checkComplete(){
        ...
        if (complete) {
            new AlertDialog.Builder(getContext()).setTitle("很抱歉").setMessage("游戏结束").setPositiveButton("重新开始", new DialogInterface.OnClickListener() {
